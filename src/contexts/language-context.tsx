...
const translations = {
  en: {
    ...
    'research.coord.1': 'Human × AI',
    'research.coord.2': 'AI-native ecosystems',
    'research.coord.3': 'Agent societies',
    'research.coord.4': 'Frontier communities',
    'research.coord.5': 'Long-horizon intelligence',
    'research.coord.6': 'Coordination at scale',
  ...
  zh: {
    ...
    'research.coord.1': '人机共生',
    'research.coord.2': 'AI 原生生态',
    'research.coord.3': '智能体社会',
    'research.coord.4': '前沿社区',
    'research.coord.5': '长程智能',
    'research.coord.6': '规模化协作',
